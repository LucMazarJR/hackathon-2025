...
export const buscarMedicos = async (req: Request, res: Response) => {
  try {
    ...
    if (especialidade && cidade) {
      medicos = buscarMedicosPorEspecialidade(especialidade as string, cidade as string);
    } else if (especialidade) {
      medicos = buscarMedicosPorEspecialidade(especialidade as string);
    } else if (cidade) {
      medicos = buscarMedicosPorCidade(cidade as string);
    } else {
...
export const realizarAgendamentoController = async (req: Request, res: Response) => {
  try {
...
export const consultarAgendamento = async (req: Request, res: Response) => {
  try {
...
export const listarCidadesController = async (req: Request, res: Response) => {
  try {
